...
//
//        //when
//        WikiPageViewResponse viewResponse = wikiDomainQueryService.getWikiPageView(dummyWikiId, dummyUserId); // 여기에서는 NullPointException 발생
//
...
//        // --- 실제 테스트 대상 호출 ---
//        // fixedNow 로 대체하여 전달
//        List<WikiPageTitleResponse> responses = wikiDomainQueryService.getRecentlyModifiedWikiPageList(pageAmount, fixedNow); // 여기에서는 NullPointException 발생
//
//        // --- 검증 ---
