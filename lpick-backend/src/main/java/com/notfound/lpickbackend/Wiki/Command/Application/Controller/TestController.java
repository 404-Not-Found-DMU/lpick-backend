...
public class TestController {
    ...
    // post임에도 requestParam이 쓰인이유는, SpringSecurity 기반 적용 이후 ContextHolder에서 ID 가져오기 위함.
    ...
    public ResponseEntity<PageRevisionResponse> dummyPageRevision(@RequestBody PageRevisionRequest request,
        ...
        PageRevisionResponse newRevision = revisionService.writeNewRevision(request, dummyUserId);
