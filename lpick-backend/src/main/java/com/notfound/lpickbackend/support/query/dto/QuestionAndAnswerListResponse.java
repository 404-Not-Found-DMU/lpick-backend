...
public class QuestionAndAnswerListResponse {
    ...
    public static QuestionAndAnswerListResponse from(Question question) {
        return new QuestionAndAnswerListResponse (question);
    }

    public QuestionAndAnswerListResponse (Question question) {
