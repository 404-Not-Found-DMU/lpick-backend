...
(
    expert_request_id varchar(40)  NOT NULL,
    oauth_id          varchar(50)  NOT NULL,
    name             varchar(50) NOT NULL,
    ...
    music_genre      jsonb        NOT NULL DEFAULT '[]'::jsonb,
    request_file_json jsonb        NOT NULL DEFAULT '[]'::jsonb,
    rejected_cause    text         NULL,
...
ALTER TABLE expert_request
    ADD CONSTRAINT pk_expert_request
        PRIMARY KEY (expert_request_id);
...
ALTER TABLE expert_request
    ADD CONSTRAINT fk_expert_request_user_info
        FOREIGN KEY (oauth_id)
            REFERENCES user_info (oauth_id) ON DELETE CASCADE;
