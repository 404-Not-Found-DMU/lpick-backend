...
INSERT INTO user_info(oauth_id, oauth_type, nickname, profile, point, stack_point, about, lpti, tier_id) VALUES
                        ('1', 'kakao', 'mock_user', '', 0, 0, '자기소개', null, '1') ON CONFLICT (oauth_id) DO NOTHING;
